            ...
            <tr>
                ...
                <td>
                    ...
                    <form method="POST" style="display: inline;">
                        ...
                        <button type="submit" name="delete_teacher" class="btn"
...
<div id="addTeacherModal" class="modal">
    <div class="modal-content">
        ...
        <form method="POST" onsubmit="return validateTeacherForm()">
            <div id="addTeacherErrors" class="message error" style="display: none;"></div>
...
<div id="editTeacherModal" class="modal">
    <div class="modal-content">
        ...
        <h2>Edit Teacher</h2>
        <form method="POST" onsubmit="return validateEditTeacherForm()">
            <div id="editTeacherErrors" class="message error" style="display: none;"></div>
...
<script>
    ...
    function validateTeacherForm() {
        ...
        const errorBox = document.getElementById('addTeacherErrors');
        let errors = [];
        ...
        if (!email.includes('@')) {
            ...
            errors.push("Email must be from: " + allowedDomains.join(", "));
        }
    ...
    function validateEditTeacherForm() {
        ...
        const errorBox = document.getElementById('editTeacherErrors');
        let errors = [];
